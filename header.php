...
<body>
    ...
    <div class="full-width-div">
        <div class="container_12">
            ...
            <?php }else { ?>
                <ul class="nav nav-pills nav-stacked text-center" id="myTab">
                    <?php  if($current_page=="summary.php" || $current_page=="summary2.php") { ?>
                        ...
                        <li id="supports_tab"><a id="btn_support" class="nl" href="#" data-toggle="tab" onclick="return support();">Support</a></li>
                ...
                <?php if($current_page == "customer.php") { ?>
                    <div class="container_12" hidden>
                        <div class="grid_10 push_2 dynamic" hidden></div>    
                    </div>
                <?php } ?>
            <?php }?>
            </div>
